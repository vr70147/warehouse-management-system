...
func (ns *NotificationService) SendOrderShippedNotification(email string) error {
	return ns.sendNotification(email, "Your Order is Shipped", "Dear User, Your order has been shipped.")
}
